                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-left"><b>
                        <form method="post">
                          <button style="border:none; background:none; padding:0; color:#0073b7;" type="submit" name="thread" id="thread" value="<?php echo "$row[thread_id]";?>"><?php echo"$row[thread_judul]"; if($row1['thread_access']=='private'){echo" &nbsp;<i class='fa fa-lock'></i>";}?></button>
                        </form>
